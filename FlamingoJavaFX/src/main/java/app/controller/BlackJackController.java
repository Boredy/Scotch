	...
	public void HandleTableState(Table t) {
		...
		for (Player p: t.GetTablePlayers())
		{
			...
			case 0:
				...
				lbl = lblBottomName;
				btn.setText("Leave");
				btnTop.setVisible(!p.getPlayerID().equals(FlamingoGame.getAppPlayer().getPlayerID()));
			...
			case 2:
				...
				lbl = lblTopName;
				btn.setText("Leave");
				btnBottom.setVisible(!p.getPlayerID().equals(FlamingoGame.getAppPlayer().getPlayerID()));
				break;
			}
